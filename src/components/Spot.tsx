    ...
    <>
      ...
      >
        <input
          ...
          className="col-span-9 flex h-10 w-full rounded-xl border px-3 py-2 text-sm shadow outline-blue-600"
          type="text"
          {...messageInputProps}
          minLength={1}
          maxLength={280}
        ...
        <button
          type="submit"
          className=" col-span-3 rounded-xl bg-blue-600 px-3 py-2 text-sm font-semibold text-white drop-shadow"
        >
          Send
        </button>
      </form>
