        ...
        <main className="mx-auto flex h-full w-full max-w-prose flex-col px-8 py-16 text-left text-slate-50">
          <div className="m-auto">
            ...
            <p className="tracking-wide text-slate-200">
              I'm not sure what to do with this site just yet but hopefully I
              can think of something cool to park here alongside my assignments.
              Speaking of which, maybe I should add a menu so you can actually
              get to them...
            </p>
